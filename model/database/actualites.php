...
class actualites {
	 ...
	 public $actualites=array();
                ...
                public function __construct($actualites=null) {
...
$this->photo = $photo;
                    ...
                    */ 
                    ...
                    {
                        if ($id != null && is_array($this->actualites) && count($this->actualites)!=0) {
...
$this->actualites =$data; 
 return $this;
                    ...
                    */ 
                    ...
                    {
                        if ($titre != null && is_array($this->actualites) && count($this->actualites)!=0) {
                            $table_name = strtolower(get_class($this));
...
$this->actualites =$data; 
 return $this;
                    ...
                    */ 
                    ...
                    {
                        if ($description != null && is_array($this->actualites) && count($this->actualites)!=0) {
                            $table_name = strtolower(get_class($this));
...
$this->actualites =$data; 
 return $this;
                    ...
                    */ 
                    ...
                    {
                        if ($auteur != null && is_array($this->actualites) && count($this->actualites)!=0) {
                            $table_name = strtolower(get_class($this));
...
$this->actualites =$data; 
 return $this;
                    ...
                    */ 
                    ...
                    {
                        if ($date != null && is_array($this->actualites) && count($this->actualites)!=0) {
                            $table_name = strtolower(get_class($this));
...
$this->actualites =$data; 
 return $this;
                    ...
                    */ 
                    ...
                    {
                        if ($lieu != null && is_array($this->actualites) && count($this->actualites)!=0) {
                            $table_name = strtolower(get_class($this));
...
$this->actualites =$data; 
 return $this;
                    ...
                    */ 
                    ...
                    {
                        if ($category_id != null && is_array($this->actualites) && count($this->actualites)!=0) {
                            $table_name = strtolower(get_class($this));
...
$this->actualites =$data; 
 return $this;
                    ...
                    */ 
                    ...
                    {
                        if ($photo != null && is_array($this->actualites) && count($this->actualites)!=0) {
                            $table_name = strtolower(get_class($this));
