...
$this->config["tables"] = ['actions','country','document','entity','files','membre','model','module','module_role','roles','type_agent','type_document','users','ville',];
...
$this->config['tables']['document'] = ['id_document','matricule','entity','entity_matricule','first_name','last_name','phone_number','birthday',];

$this->config['tables']['actions']['id'] = ['id'];$this->config['tables']['country']['id'] = ['id'];$this->config['tables']['document']['id'] = ['id_document'];

$this->config['tables']['entity'] = ['id_entity','label','domaine','email','phone_number','bp','localisation','uniqueId','created_at','created_by','update_at','update_by',];
...
$this->config['tables']['actions']['id'] = ['id'];$this->config['tables']['country']['id'] = ['id'];$this->config['tables']['document']['id'] = ['id_document'];$this->config['tables']['entity']['id'] = ['id_entity'];$this->config['tables']['files']['id'] = ['id'];
...
$this->config['tables']['actions']['id'] = ['id'];$this->config['tables']['country']['id'] = ['id'];$this->config['tables']['document']['id'] = ['id_document'];$this->config['tables']['entity']['id'] = ['id_entity'];$this->config['tables']['files']['id'] = ['id'];$this->config['tables']['membre']['id'] = ['id_membre'];

$this->config['tables']['model'] = ['id_model','model_name','entity','uniqueId',];

$this->config['tables']['actions']['id'] = ['id'];$this->config['tables']['country']['id'] = ['id'];$this->config['tables']['document']['id'] = ['id_document'];$this->config['tables']['entity']['id'] = ['id_entity'];$this->config['tables']['files']['id'] = ['id'];$this->config['tables']['membre']['id'] = ['id_membre'];$this->config['tables']['model']['id'] = ['id_model'];

$this->config['tables']['module'] = ['id','name','icon','description','action_url','sub_module','is_menu',];

$this->config['tables']['actions']['id'] = ['id'];$this->config['tables']['country']['id'] = ['id'];$this->config['tables']['document']['id'] = ['id_document'];$this->config['tables']['entity']['id'] = ['id_entity'];$this->config['tables']['files']['id'] = ['id'];$this->config['tables']['membre']['id'] = ['id_membre'];$this->config['tables']['model']['id'] = ['id_model'];$this->config['tables']['module']['id'] = ['id'];

$this->config['tables']['module_role'] = ['id','role_id','module',];

$this->config['tables']['actions']['id'] = ['id'];$this->config['tables']['country']['id'] = ['id'];$this->config['tables']['document']['id'] = ['id_document'];$this->config['tables']['entity']['id'] = ['id_entity'];$this->config['tables']['files']['id'] = ['id'];$this->config['tables']['membre']['id'] = ['id_membre'];$this->config['tables']['model']['id'] = ['id_model'];$this->config['tables']['module']['id'] = ['id'];$this->config['tables']['module_role']['id'] = ['id'];
