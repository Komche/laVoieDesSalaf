  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="card">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form id="clivreForm" role="form" method="post">
          <div class="card-body">
          ...
          <div class="card-footer">
            <button type="submit" onclick="postData('clivreForm', 'clivre'<?= (!empty($_GET['modif']) ? ', ' . $_GET['modif'] : '') ?>)" class="btn btn-success"><?= $GLOBALS['lang']['btn-valid'] ?? 'valider' ?></button>
            <p id="postMessage">
            ...
            <tbody>
              ...
              ?>
                  <tr>
                    <td><?= $value['titre'] ?></td>
                    <td>
                      <a href="javascript:void()" onclick="getHTML('clivre&modif=<?= $value['id'] ?>')" class="btn btn-success">
