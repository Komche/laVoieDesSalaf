...
$totalModel = countFields('model', 'entity', $uniqueId)['nb'];
$totalDocument = countFields("document", "entity", $entity)['nb'];
ob_start();
?>
...
<?php if (is_numeric($totalDocument) || is_numeric($totalModel)) : ?>
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-7 text-right">
                                        ...
                                        <h4 class="mb-0"><?= $totalDocument ?></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer">
        ...
        <?php else : ?>
            <div class="col-md-12 col-lg-12 col-xl-12">
                <div class="text-center mt-3 mb-5">
                    <h4>Vos statistique vont s'afficher ici</h4>
                </div>
            </div>
        <?php endif; ?>
