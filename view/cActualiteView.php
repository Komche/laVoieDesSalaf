...
if (!empty($_GET['modif']) && ctype_digit($_GET['modif'])) {
  ...
  $datas = Manager::getData("cactulaites", "id", $_GET['modif'])['data'];
}
ob_start();
?>
        ...
        <div class="card-body">
          <table class="table table-bordered">
            <tbody>
              ...
              <?php
              $cactulaite = new cactualites();
              $data = Manager::getDatas($cactulaite)->all();
              ...
              ?>
                  <tr>
                    <td><?= $value['titre'] ?></td>
                    <td>
                      <a href="index.php?action=cactulaite&modif=<?= $value['id'] ?>" class="btn btn-primary">
